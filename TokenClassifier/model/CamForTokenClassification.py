...
class CamembertForTokenClassification(CamembertPreTrainedModel):
    ...
    def _forward_inference(self, encodings: torch.tensor, context_masks: torch.tensor, input_tokens: list, entity_types : dict):
        ...
        # retrieve entities
        classified_entities = self.get_batch_ents(entity_logits, input_tokens, context_masks, entity_types)
        return classified_entities
                          
 

    def get_ents(self,entity_logits, input_tokens,context_masks,entity_types):
    ...
    def get_batch_ents(self, entity_logits, input_tokens, context_masks, entity_types):
        ...
        for batch_index in range(batch_size):
            ...
            current_classified_entities = self.get_ents(entity_logits[batch_index], input_tokens[batch_index],context_masks[batch_index],entity_types)
